 ...
 * Generated at: 2023-03-09 01:08:12 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/common/menubar.jsp", Long.valueOf(1678161007540L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("	\r\n");
      out.write("	*공지사항서비스	  - 공지사항리스트조회 (R) / 공지사항상세조회(R) / 공지사항작성(C) / 공지사항수정(U) / 삭제(U/D)\r\n");
      out.write("	\r\n");
      out.write("	*일반게시판서비스  - 일반게시판리스트조회 (R) -> 페이징 처리(페이지로 넘어갈 수있는 버튼)/ 일반게시판상세조회(R) / 일반게시판작성(C)-> 첨부파일 1개 업로드 기능  / 공지사항수정(U) / 삭제(U/D)  =>  [댓글 리스트 조회(R)/작성(C)]\r\n");
      out.write("	*사진게시판서비스  - 리스트조회(R) / 상세조회(R) / 작성(C) -> 다중 첨부파일 업로드(썸네일 게시판)\r\n");
      out.write("\r\n");
      out.write(" -->\r\n");
      out.write(" \r\n");
      out.write(" \r\n");
 ...
 if(loginUser == null){ 
      ...
      out.write("						<input type=\"checkbox\" id=\"saveId\"><label for=\"saveId\">아이디저장</label>\r\n");
      ...
      out.write("		            	document.cookie =\"saveId=; path=/; max-age=0\"; //최대시간을 0으로 설정해서 해당 쿠키를 제거해주기\r\n");
      out.write("		               \r\n");
      out.write("		            }\r\n");
      out.write("		            \r\n");
      out.write("		            \r\n");
      ...
      out.write("					    	//index += \"saveId=\".length; : 불필요한 값을 제거하기위해 내가뽑아쓸 글자 수 만큼 길이를 늘린것?\r\n");
      out.write("					    	//							 : 없으면 saveId=admin으로 값이 찍힘							\r\n");
      out.write("					    	let end = document.cookie.indexOf(\";\",index);\r\n");
      out.write("					    	\r\n");
      out.write("					    	if(end == -1){ //쿠키배열에서 saveId가 마지막위치에 있을때\r\n");
