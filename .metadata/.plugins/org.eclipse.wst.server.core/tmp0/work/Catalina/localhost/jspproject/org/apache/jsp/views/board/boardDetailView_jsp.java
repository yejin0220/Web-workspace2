 ...
 * Generated at: 2023-03-07 01:37:06 UTC
...
public final class boardDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("com.kh.borard.model.vo");
 ...
 if(loginUser == null){ 
      ...
      out.write("               ");
 if(at == null){
      out.write(" <!-- at에 저장된 첨부파일이 없는 경우 -->\r\n");
      out.write("               		첨부파일이 없습니다.\r\n");
      out.write("               \r\n");
      out.write("               ");
}else{ 
      out.write("\r\n");
      out.write("               		<!--  href = '/jspproject/resources/board_upfiles/202xxxxxx.jpg -->\r\n");
      ...
      out.write('>');
      out.print( at.getOriginName() );
      out.write("</a> <!-- filePath : 파일의 경로가 저장되어 있음 -->\r\n");
      out.write("               ");
} 
      out.write("\r\n");
      out.write("            \r\n");
 ...
 if(loginUser != null && loginUser.getUserId().equals(b.getBoardWriter() )) { 
      ...
      out.write("      \r\n");
      out.write("      <br>\r\n");
      out.write("      <!-- 댓글기능 화면구현만 해두기, 요 아래 작업x -->\r\n");
      out.write("      \r\n");
 ...
 if(loginUser != null) { 
      ...
      out.write("                      <th>댓글작성</th>\r\n");
      out.write("                      <td>\r\n");
      out.write("                         <textarea id=\"replyContent\" cols=\"50\" rows=\"3\" style=\"resize:none;\" readonly>로그인 후 이용가능한 서비스입니다.</textarea>\r\n");
      out.write("                      </td>\r\n");
 ...
 for(Reply r : list){ 
      ...
      out.write("   <script>\r\n");
      out.write("   		$(function(){\r\n");
      out.write("   			setInterval(selectReplyList, 1000); //내가 원하는 함수를 원하는 시간마다 호출하는것\r\n");
      out.write("   		});\r\n");
      out.write("   		\r\n");
      ...
      out.write("   						//새 댓글목록 불러오는 함수 호출\r\n");
      out.write("   						selectReplyList();\r\n");
      out.write("   						\r\n");
      out.write("   						//댓글 내용 비워주기\r\n");
      out.write("   						$(\"#replyContent\").val(\"\");\r\n");
      out.write("   					}else{\r\n");
      out.write("   						\r\n");
      out.write("   						//댓글 등록 실패시 result =0\r\n");
      out.write("   						alert(\"댓글 작성에 실패\")\r\n");
      out.write("   					\r\n");
      out.write("   					}\r\n");
      out.write("   				},\r\n");
      ...
      out.write("   				},\r\n");
      out.write("   				error : function(){\r\n");
      out.write("   					console.log(\"게시글 목록 조회 실패\")\r\n");
      out.write("   				}\r\n");
      out.write("   				\r\n");
      out.write("   			})\r\n");
      out.write("   		}\r\n");
