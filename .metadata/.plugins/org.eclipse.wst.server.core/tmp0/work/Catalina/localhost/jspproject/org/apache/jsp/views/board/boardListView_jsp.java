 ...
 * Generated at: 2023-02-21 00:32:53 UTC
...
public final class boardListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.kh.borard.model.vo.Board");
 ...
 if(loginUser == null){ 
      ...
      out.write("		<br>\r\n");
      out.write("		\r\n");
      out.write("		<!-- 글등록 버튼 (로그인한 회원만 보이도록 -->\r\n");
      out.write("		");
if(loginUser != null){ 
      out.write("\r\n");
...
if(list.isEmpty()) { 
      out.write("\r\n");
      out.write("					<tr>\r\n");
      out.write("						<td colspan=\"6\">조회된 리스트 없어</td>\r\n");
      out.write("					</tr>\r\n");
      out.write("				");
} else {
      out.write("\r\n");
...
for(Board b : list){ 
      ...
      out.write("					\r\n");
      out.write("					//클릭시 해당 게시글의 글번호를 알아와야 함.\r\n");
      out.write("					//tr요소의 자손 중 첫번째 td태그의 영역안의 내용을 가져올 예정 \r\n");
      out.write("					let bno = $(this).children().eq(0).text();\r\n");
      out.write("					//현재 내가 클릭한 tr태그의 자손들 중 0번째에 위치한 자식의 textNode값을 가져온다\r\n");
      out.write("				\r\n");
      out.write("					//요청할 url -> get방식 : url?키=밸류&&키=밸류...\r\n");
      out.write("					//물음표뒤의 내용을 쿼리 스트링이라고 부름 => 직접 만들어서 넘겨줘야 함	\r\n");
      out.write("					location.href='");
      out.print(contextPath);
