 ...
 * Generated at: 2023-02-22 01:27:47 UTC
...
public final class boardUpdateForm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null){ 
      ...
      out.write("\">\r\n");
      out.write("	         <!-- 카테고리, 제목,내용, 첨부파일을 입력받고, 작성자정보  -->\r\n");
      out.write("	         <table align=\"center\">\r\n");
      out.write("		         <tr>\r\n");
      out.write("		         	<!-- \r\n");
      out.write("		         		DB로부터 카테고리 정보를 조회해서 보여주게끔하는게 좋다.\r\n");
      out.write("		         		카테고리가 새롭게 추가되거나, 삭제되는 경우 해당 카테고리를 참조하고 있는 모든 JSP에 들어가서 일일이 수정해줘야 하기 때문에\r\n");
      out.write("		         	 -->\r\n");
 ...
 for (Category c : list){ 
      ...
      out.write("\r\n");
      out.write("		               \r\n");
      out.write("		                <!-- 내가 선택한 카테고리가 자동으로 선택되어 있도록 작업해주기(js활용) -->\r\n");
      out.write("		               </select>\r\n");
      out.write("		               <script>\r\n");
      out.write("			               	$(function(){\r\n");
      out.write("			               		$(\"#update-form option\").each(function(){\r\n");
      out.write("			               			/*\r\n");
      out.write("			               				현재 반복을 진행중인 option태그의 text값과\r\n");
      out.write("			               				db에서 가져온 categoryname값이 일치하는 경우 선택되도록\r\n");
      out.write("			               			*/\r\n");
      out.write("			               			\r\n");
      out.write("			               			if($(this).text() == \"");
      out.print( b.getCategory());
      out.write("\"){\r\n");
      out.write("			               				//일치하는 경우에만 option태그를 선택 상태로 변경\r\n");
...
if(at != null) { 
      ...
      out.write("\r\n");
      out.write("		         			\r\n");
      out.write("		         			<!-- 원본파일의 파일 번호, 수정명을 hidden으로 함께 전송할 예정 -->\r\n");
