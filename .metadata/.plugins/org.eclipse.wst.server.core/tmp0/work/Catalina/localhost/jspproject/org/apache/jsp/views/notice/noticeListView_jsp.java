 ...
 * Generated at: 2023-02-16 01:59:31 UTC
...
public final class noticeListView_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null){ 
      ...
      out.write("		<br>\r\n");
      out.write("		\r\n");
      out.write("		<!-- 공지사항 게시판의 게시판은 관리자만 작성이 가능함 -->\r\n");
      out.write("		");
...
if(list.isEmpty()){ 
 ...
 for( Notice n  : list  ) { 
      ...
      out.write("				\r\n");
      out.write("				//클릭했을때 해당 공지사항의 번호를 가지고 올 수 있어야 함\r\n");
      out.write("				//this = tr태그\r\n");
      out.write("				//nno => 글번호 : tr태그의 자식들인 td태그 중에서 0번째에 있는 td의 텍스트만 가지고 옴 \r\n");
      out.write("				let nno = $(this).children().eq(0).text();\r\n");
      out.write("				\r\n");
      out.write("				//GET방식으로 요청시 URL뒤에 ?를 붙여서 파라미터를 함께 전송할 수 있음\r\n");
      out.write("				// ? KEY = VALUE & KEY=VALUE ,, => 길이에 한계가 있음\r\n");
      out.write("				// ? 뒤에 오는 내용들을 쿼리스트링이라고 부름\r\n");
      out.write("				//nno값은 클릭했을 때 이동할 게시판의 글 번호\r\n");
      out.write("				location.href = \"");
      out.print( contextPath );
